...
tinyimagenet_train_1 = transforms.Compose([
...
tinyimagenet_train_2 = transforms.Compose([
    transforms.RandomResizedCrop(64),
    transforms.RandomHorizontalFlip(),
    transforms.ColorJitter(brightness=63 / 255),
    ImageNetPolicy(),  
...
tinyimagenet_test_1 = transforms.Compose([
...
transform_dict = {
    ...
    'tinyimagenet_train_1': tinyimagenet_train_1,
    'tinyimagenet_train_2': tinyimagenet_train_2,
    'tinyimagenet_test_1': tinyimagenet_test_1,
}
...
default_transform_dict = {
    ...
    'tinyimagenet': ('tinyimagenet_train_1', 'tinyimagenet_test_1'), 
}
