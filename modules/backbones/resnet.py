...
from iCBP.cbp_linear import CBPLinear
from iCBP.cbp_conv import CBPConv
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, replacement_rate=1e-5, maturity_threshold=1000, init='kaiming'):
        ...
        self.stride = stride
        self.cbp = CBPConv(in_layer=self.conv1, out_layer=self.conv2, replacement_rate=replacement_rate, maturity_threshold=maturity_threshold, init=init)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, dataset_name='imagenet', small_base=True, replacement_rate=1e-5, maturity_threshold=1000, init='kaiming'):
    ...
    def _make_layer(self, block, planes, blocks, replacement_rate=1e-5, maturity_threshold=1000, init='kaiming', stride=1, dilate=False):
